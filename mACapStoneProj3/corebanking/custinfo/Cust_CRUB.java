...
public class Cust_CRUB {
    ...
    public static int insCust() throws Exception {
        ...
        if (CustDAO.chkCustNric(nric)) {
            CustDAO.insertCust(new Cust(nric, name, address, email, mobileNo,
                    DOBdate, startDate, (byte) 1));
        }

        //printHeader();
//        if (CustDAO.insertCust(new Cust(nric, name, address, email,
//                mobileNo, LocalDate.parse(dob, DateTimeFormatter.ISO_DATE), 
//                            startDate)
//        )){
//             printFooter();
//        }
