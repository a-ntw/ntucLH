...
public class AuthServlet extends HttpServlet {
    ...
    protected void setLoggedInStatus(String userid) throws SQLException {
        Connection con = ds.getConnection();
        String stmt = "update HR.HR_AUTHEN SET INUSE=1 where USERID='" + userid + "'";
        Statement st = con.createStatement();
    ...
    protected void setLoggedOutStatus(String userid) throws SQLException {
        Connection con = ds.getConnection();
        String stmt = "update HR.HR_AUTHEN SET INUSE=0 where USERNAME='" + userid + "'";
    ...
    protected String loginNow(String userid, String pwd) throws SQLException {
        Connection con = ds.getConnection();
        String stmt = "select USERNAME from HR.HR_AUTHEN where USERID='" + userid + "' and PASSWORD='" + pwd + "' ";
        Statement st = con.createStatement();
        ResultSet rs = st.executeQuery(stmt);
